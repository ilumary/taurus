...
\begin{itemize}
    ...
    \item \textbf{Retry Packets} employ AEAD\_AES\_128\_GCM\todo{ref to definitions} to prevent inadvertent tampering and restrict the entities capable of producing a valid Retry.
...
\subsection{Loss Detection \& Recovery}
